...
# gui apps
pacman -S --noconfirm gvim lightdm lightdm-gtk-greeter i3-wm i3status dmenu termite chromium firefox virtualbox compton feh evince libreoffice inkscape gimp inkscape i3lock shutter gnome-web-photo wireshark xdot

systemctl enable lightdm

# cli apps
pacman -S --noconfirm f2fs-tools openssh vagrant gnu-netcat pkgfile bind-tools nmap nethogs sudo htop tmux iotop git tig the_silver_searcher puppet dos2unix ncdu ranger docker rsync aria2 whois aws-cli graphviz pwgen docker-compose wget
pkgfile -u

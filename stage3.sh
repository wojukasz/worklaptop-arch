...
# cli apps
pacman -S --noconfirm f2fs-tools openssh vagrant gnu-netcat pkgfile bind-tools nmap nethogs sudo htop tmux iotop git tig the_silver_searcher puppet dos2unix ncdu ranger docker rsync aria2 whois aws-cli graphviz pwgen docker-compose
pkgfile -u
